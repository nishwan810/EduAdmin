...
<body class="  mx-4 mt-3 pt-5">
	...
	<%
	String successMessage = (String) session.getAttribute("submitassign");
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page"><%=c1.getCourseName()%></li>
			...
			<div class="">
				<div class="">
					<a class="navbar-brand " href="#"><svg
							...
							<path
								d="M160-200v-80h80v-280q0-83 50-147.5T420-792v-28q0-25 17.5-42.5T480-880q25 0 42.5 17.5T540-820v28q80 20 130 84.5T720-560v280h80v80H160Zm320-300Zm0 420q-33 0-56.5-23.5T400-160h160q0 33-23.5 56.5T480-80ZM320-280h320v-280q0-66-47-113t-113-47q-66 0-113 47t-47 113v280Z" /></svg></a>
				</div>
			</div>
		...
		<div class="row">
			<div class=" container d-flex col-12 col-md-9">
				...
				<div class="border w-100 border-light-subtle p-3">
					...
					<p class="roboto-100 fs-2">
						Course Code :-
						<%=c1.getCourseCode()%></p>

					<hr>
					<p class="roboto-400 fs-1">Syllabus</p>
					<a href="<%=c1.getSyllabus()%>"> <svg
	...
	<div class="container-fluid pt-4 ">
		...
		<div class="border border-light-subtle p-3">
			...
			for (assignment temp : assignmentList) {
				...
				if (c1.getId() == Integer.parseInt(temp.getId())) {

					String accordionId = "accordionFlushExample" + temp.getAssignid();
					String collapseId = "flush-collapse" + temp.getAssignid();
			%>
				...
				<div class="container mt-4">
					...
					<div class=" pt-4">
						<div>
							...
							<p class="roboto-400 fs-4">
								Assignment Number
								<%=temp.getAssignid()%></p>
							<p>
								<a>Assignment Name :- <%=temp.getTitle()%></a>
							</p>
                        ...
                        <g fill="#00a0ff" fill-rule="nonzero"
							...
							<path
										d="M12.5,11c-1.93,0 -3.5,1.57 -3.5,3.5v21c0,0.537 0.13066,1.03914 0.34766,1.49414l4.01367,-12.89062c0.578,-1.856 2.2738,-3.10352 4.2168,-3.10352h22.90039c0.179,0 0.34848,0.03455 0.52148,0.06055v-3.56055c0,-1.93 -1.57,-3.5 -3.5,-3.5h-15c-0.538,0 -1.071,-0.178 -1.5,-0.5l-2.40039,-1.80078c-0.601,-0.451 -1.34661,-0.69922 -2.09961,-0.69922zM17.57813,22c-1.503,0 -2.81277,0.96439 -3.25977,2.40039l-4.24023,13.61523c0.629,0.606 1.48087,0.98438 2.42188,0.98438h23.51172c1.376,0 2.59011,-0.79181 3.16211,-2.00781l3.67773,-11.76172c0.239,-0.764 0.10486,-1.5718 -0.36914,-2.2168c-0.226,-0.308 -0.88591,-1.01367 -2.00391,-1.01367z"></path></g></g>
                        </svg> Assignment description

							</a>

							<%
							String storedDueDate = temp.getDuedate(); // Example stored date
								...
								<div class="accordion-item">
									...
									<div id="<%=collapseId%>" class="accordion-collapse collapse"
										...
										<div class="accordion-body">
											...
											<form id="courseForm" action="SubmitAssignController"
												method="post">
												<input type="hidden" name="assignid"
													value="<%=temp.getAssignid()%>">




												<div class="mb-3">
													<label for="description" class="form-label">Assignment
														link</label> <input type="url" class="form-control"
														name="Assignmentlink"
														placeholder="Enter Assignment description document URL"
														required>
												</div>
												...
												<div class="mb-3">
													...
													<button type="reset" class="btn btn-secondary"
														id="resetBtn" onclick="resetForm()">Reset</button>
											...
											%>
											<p>
												<strong>Assignment is Overdue</strong>
											</p>
